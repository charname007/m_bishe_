...
请输出：
1. `batch_eval_results`：每条包含 `corpus_id`, `scores`, `entity_scores`, `eval_passed`, `corrected_triples`, `confidence`
...
| 属性 | 类型 | 规范值 |
|------|------|------|
| 事件类别 | 枚举(7种) | 自然事件/人文事件/商业活动/社会事件/业态变更/停业关闭/其他 |
...
| 属性 | 类型 | 规范值 |
|------|------|------|
| 维度 | 列表(枚举) | 价格/环境/服务/人流量/品质/交通/口味/其他 |
